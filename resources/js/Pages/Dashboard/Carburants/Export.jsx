      ...
      <Head title={page_title}/>
        ...
        <CardBody>
          ...
          <div className='overflow-auto'>
            <table className=" w-full border  min-w-max table-auto text-left border-collapse border-spacing-0">
              ...
              <tbody>
                ...
                {carburants && carburants.length && carburants.map(({ id, nom, description, photo}, index) => {
                  const isLast = index === carburants.length - 1;
                  const classes = isLast
                    ? "px-4 py-2 border-b print__:p-0 print:border-0"
                    : "px-4 py-2 border-b print__:p-0 print:border-0 border-b_border-blue-gray-50 ";
