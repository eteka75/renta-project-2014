                                    ...
                                    <tr className='hover:bg-gray-100 dark:hover:bg-gray-900  transition-all duration-500' key={id}>
                                        <td className={classes}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                {photo ? <Link href={route('dashboard.voitures.show', id)}><Avatar src={HTTP_FRONTEND_HOME + '' + photo} alt={nom} variant="rounded" className=' border-1 h-10 bg-white  rounded-sm' size="md" /></Link>:
                                        ...
                                        <td className={classes + ' items-center '}>
                                         ...
                                         <div className="pt-4">  {disponibilite === 1 ? <Badge title='Disponible' color="green">&nbsp;</Badge> : <Badge title='indisponible' color="gray">&nbsp;</Badge>}</div> 
                                        </td>
