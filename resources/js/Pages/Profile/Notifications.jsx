                        ...
                        <div className="" id="chec-div">
                            <div className=" z-10 right-0 h-full overflow-x-hidden_ transform translate-x-0 transition ease-in-out duration-700" id="notification">
                                <div className=" ">
                                    ...
                                    { notifications!=null && notifications?.data?.length > 0 && notifications?.data?.map(({ message,lien }, index) => (
                                         <div className="w-full p-3 mt-2 border hover:bg-gray-50 dark:hover:bg-gray-800/70 dark:border-gray-700/90 bg-white dark:text-white dark:bg-gray-800  rounded flex items-center">
                                         <div tabindex="0" aria-label="post icon" role="img" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 dark:border-gray-700 flex items-center justify-center">
                                            ...
                                            <div className="pl-3 w-full flex items-center justify-between">
                                                <p tabindex="0" className="focus:outline-none text-sm leading-none ">{message}</p>
                                                {lien!=null && lien!=null && <Link to={lien}><p tabindex="0" className="focus:outline-none text-xs leading-3 cursor-pointer me-2 text-right dark:text-white text-gray-700">Consulter</p></Link>}
                                            </div>
                                        </div>
                                    ))}
