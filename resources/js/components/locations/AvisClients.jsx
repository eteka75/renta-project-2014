    ...
    <>
      <div className="border-bborder-t container mx-auto">
        ...
        <div className="mt-4 py-3 text-center justify-center">
          <Link href={route('front.avis')} className="flex max-w-[200px] mx-auto rounded-md py-2 gap-2 border text-blue-600 font-bold bg-gray-300/20 hover:bg-slate-200 dark:border-slate-600 dark:hover:bg-slate-800 dark:bg-blue-600 dark:text-white items-center justify-center"> Tous les avis <IoArrowForwardOutline/> </Link>
          </div>
      </div>
    </>
  )
