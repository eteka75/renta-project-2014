        ...
        <>
            ...
            <div className="max-w-screen-xl mx-auto px-4 ">
                <div className=" mx-auto">
                    ...
                    <Link href={route('front.faqs')} className=' items-center py-2 px-0 mx-auto flex bg-white hover:opacity-70   text-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold   text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>
