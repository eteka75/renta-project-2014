        ...
        <div className={className}>
            <Card className=" bg-[#F2FFF7] border-[#39935d] border  shadow-none rounded-lg ">
                ...
                <div className="p-4 font-bold  text-blue-500 text-lg">                   
                    <Link href={url}>
                        <Button variant='text' color='white' className='w-full text-center items-center flex gap-2 justify-center  dark:text-white hover:bg-black bg-[#21693e] text-white mt-4 mt-4'>
