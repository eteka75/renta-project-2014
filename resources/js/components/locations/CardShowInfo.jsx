        ...
        <div className={className}>
            <Card className="dark:shadow-xl  bg-blue-50 border-blue-300 dark:bg-blue-800 dark:border-blue-600 border  shadow-none rounded-lg ">
                ...
                <div className="p-4 font-bold  text-blue-500  text-lg">                   
                    <Link href={url}>
                        <Button variant='text' color='white' className='w-full text-center py-4 md:py-3 items-center flex gap-2 justify-center dark:bg-slate-900 dark:text-yellow-500 hover:bg-black bg-[#003366] text-white mt-4 mt-4'>
