...
export default function Pagination({ links,className }) {
    ...
    function getClassName(active) {
        if (active) {
            return "mr-1 mb-1 dark:hover:text-white px-4 py-3 text-sm leading-4 border dark:border-0 text-sm dark:text-black dark:bg-yellow-500 rounded dark:border-slate-500 hover:bg-blue-800 hover:text-gray-slate-200 focus:border-primary focus:text-primary bg-blue-700 text-white";
        } else {
