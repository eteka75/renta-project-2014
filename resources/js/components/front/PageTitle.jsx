...
export default function PageTitle({ title, children, head = true }) {
    ...
    return (
        <>
            ...
            <div className="bg-[#f5f6f8] dark:bg-gray-800 dark:border-t dark:border-b dark:border-gray-700   overflow-auto max-w-full  dark:text-white lg:shadow-inner mt-0">
